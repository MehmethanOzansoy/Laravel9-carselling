                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        <a href="/admin" class="nav-link active">
                            <ion-icon name="home-sharp"></ion-icon> Dashboard
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="/admin/category" class="nav-link active">
                            <ion-icon name="apps-outline"></ion-icon> Categories
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="/admin/car" class="nav-link active">
                    ...
                    <li class="nav-item">
                        <a href="/admin/social" class="nav-link active">
                            <ion-icon name="share-social-outline"></ion-icon> Social
                        </a>
                    </li>
